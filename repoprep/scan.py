...
def signrelease(release):
	...
	gpgargs = ['gpg', '--yes', '--clearsign', '-o', 'InRelease', 'Release']
	subprocess.check_output(gpgargs, cwd=releasedir)

	## sign seperate release.gpg file
	gpgargs = ['gpg', '--yes', '-abs', '-o', 'Release.gpg', 'Release']
	subprocess.check_output(gpgargs, cwd=releasedir)
